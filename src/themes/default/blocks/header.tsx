              ...
              return (
                <NavigationMenuLink key={idx} asChild>
                  <Link
                    ...
                    className={`flex flex-row items-center gap-1 px-4 py-1.5 text-sm transition-colors text-muted-foreground hover:text-foreground ${
  ...
  return (
    <>
      <header
        ...
        className="fixed inset-x-0 top-0 z-50 dark transition-colors duration-300"
      >
        <div
          className={cn(
            'absolute inset-x-0 top-0 z-50 py-3 transition-all duration-300',
            'in-data-scrolled:border-white/5 in-data-scrolled:bg-black/75 in-data-scrolled:border-b in-data-scrolled:backdrop-blur',
            'max-lg:in-data-[state=active]:bg-black/75 max-lg:in-data-[state=active]:h-screen max-lg:in-data-[state=active]:overflow-hidden max-lg:in-data-[state=active]:border-b max-lg:in-data-[state=active]:backdrop-blur',
            'lg:max-h-24'
          )}
        >
          <div className="container">
            <div className="relative flex flex-wrap items-center justify-between lg:py-3">
              <div className="flex items-center gap-12 max-lg:h-14 max-lg:w-full max-lg:justify-between max-lg:border-b">
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          button.variant === 'outline'
                            ? 'bg-transparent border-white/20 text-white hover:bg-white/10 border shadow-sm duration-200'
                            : 'bg-primary text-primary-foreground hover:opacity-90 border-0 shadow-lg'
                        )}
                      >
                        {button.icon && (
                          <SmartIcon
