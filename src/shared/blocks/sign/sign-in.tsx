...
export function SignIn({
  ...
  return (
    <Card className="mx-auto w-full md:max-w-md bg-white/5 border-white/10 text-white backdrop-blur-xl">
      <CardHeader>
        <CardTitle className="text-xl md:text-2xl font-bold w-fit">
          <h1 className="bg-linear-to-r from-[#9c40ff] via-[#8fdfff] to-[#9c40ff] bg-clip-text text-transparent">
            {t('sign_in_title')}
          </h1>
        </CardTitle>
